package io.github.mcclauneck.template;
...
public class Template implements IMCExtension {
    ...
    public void onLoad(JavaPlugin plugin, Executor executor) {
        ...
        if (!extensionFolder.exists()) {
            ...
            if (!created) {
                plugin.getLogger().log(Level.WARNING, "[MCClauneck] [Template] Failed to create extension directory.");
            }
        }

        plugin.getLogger().info("[MCClauneck] [Template] Loaded Successfully.");
    }
